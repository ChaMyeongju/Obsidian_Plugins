...
export interface BetterExportPdfPluginSettings {
  ...
  isTimestamp: boolean;
  autoSaveNextToMarkdown: boolean;
  debug: boolean;
  enabledCss: boolean;
  concurrency: string;
  version: string;
  ...
  registerCommand() {
    this.addCommand({
      ...
      checkCallback: (checking: boolean) => {
        ...
        new ExportConfigModal(this, file, false, {
          autoSaveNextToMarkdown: this.settings.autoSaveNextToMarkdown,
        }).open();
      ...
      this.app.workspace.on("file-menu", (menu, file: TFile | TFolder) => {
        ...
        menu.addItem((item) => {
          item
            ...
            .onClick(async () => {
              new ExportConfigModal(this, file, false, {
                autoSaveNextToMarkdown: file instanceof TFile ? this.settings.autoSaveNextToMarkdown : false,
              }).open();
            });
          });
      }),
